...
import tempCrew from '../img/crew.jpg';
...
function About() {
    return(
        <section className = "flex flex-col p-8 max-w-6xl mx-auto space-y-2">
            ...
            <div className = "text-white text-lg leading-8 pt-4">
                {AboutUs.MainAboutUs}
            </div>
            <div className = "flex flex-col lg:flex-row justify-center align-middle pt-2 md:pt-10 m-auto">
                <img className = " border-yellow-600 border-4 md:max-w-sm m-2 md:m-4 aspect-auto" src = {tempCrew}></img>
            </div>
